...
```bash
git remote add encore encore://real-time-crypto-sniping-bot-7txi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/real-time-crypto-sniping-bot-7txi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/real-time-crypto-sniping-bot-7txi/settings/integrations/github)
